...
$to = 'mgriffin50276@live.com'; //SET TO: EMAIL WHERE SHOULD THE INFO GO
...
if (!isset($first_name) && !isset($email)){ 
	...
	header('location: http://fullstackbhm.com'); //PLACE REDIRECT LOCATION HERE UPON COMPLETION FAILURE.
	...
	header('location: http://fullstackbhm.com'); //PLACE REDIRECT LOCATION HERE.
}
